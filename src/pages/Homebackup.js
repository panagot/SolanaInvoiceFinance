...
import { Box, Heading, Text, Stack, Button, VStack, HStack, Icon, SimpleGrid, Container, Badge, Flex, Image, useColorModeValue } from '@chakra-ui/react';
            ...
            <VStack spacing={6}>
              ...
              <SimpleGrid columns={{ base: 1, md: 4 }} spacing={6} w="full">
                <VStack spacing={3} position="relative">
                  ...
                  >
                    <Text fontSize="xl" fontWeight="bold" color="blue.700" textAlign="center">1</Text>
                  </Box>
                  <VStack spacing={1}>
                    <Text fontSize="md" fontWeight="bold" color="blue.700" textAlign="center">Business Uploads Invoice</Text>
                    <Text fontSize="xs" color="blue.600" textAlign="center">Upload invoice metadata & file hash</Text>
                  </VStack>
                </VStack>
                <VStack spacing={3} position="relative">
                  <Box 
                    ...
                    _hover={{ transform: "translateY(-2px)", transition: "all 0.3s ease" }}
                  >
                    <Text fontSize="xl" fontWeight="bold" color="purple.700" textAlign="center">2</Text>
                  </Box>
                  <VStack spacing={1}>
                    <Text fontSize="md" fontWeight="bold" color="purple.700" textAlign="center">NFT Minted on Solana</Text>
                    <Text fontSize="xs" color="purple.600" textAlign="center">Invoice becomes tradeable NFT</Text>
                  </VStack>
                </VStack>
                <VStack spacing={3} position="relative">
                  <Box 
                    ...
                    _hover={{ transform: "translateY(-2px)", transition: "all 0.3s ease" }}
                  >
                    <Text fontSize="xl" fontWeight="bold" color="green.700" textAlign="center">3</Text>
                  </Box>
                  <VStack spacing={1}>
                    <Text fontSize="md" fontWeight="bold" color="green.700" textAlign="center">Investors Fund Invoice</Text>
                    <Text fontSize="xs" color="green.600" textAlign="center">Global investors purchase NFT</Text>
                  </VStack>
              </VStack>
                <VStack spacing={3} position="relative">
                  <Box 
                    ...
                    _hover={{ transform: "translateY(-2px)", transition: "all 0.3s ease" }}
                  >
                    <Text fontSize="xl" fontWeight="bold" color="teal.700" textAlign="center">4</Text>
            </Box>
                  <VStack spacing={1}>
                    <Text fontSize="md" fontWeight="bold" color="teal.700" textAlign="center">Automatic Payout</Text>
                    <Text fontSize="xs" color="teal.600" textAlign="center">Smart contract distributes payment</Text>
                  </VStack>
                </VStack>
          </SimpleGrid>
        </VStack>
          ...
          <VStack spacing={6} w="full" maxW="4xl">
            ...
            >
              <Text fontSize="md" color="purple.700" fontWeight="medium">
                🚀 Built for the Startit x Superteam Balkan Hackathon 2025 — turning real-world finance into transparent DeFi.
              </Text>
            </Box>
          </VStack>
        </VStack>
